    ...
    >
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 pt-28 pb-20 text-center">
        ...
        <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto mb-10">
          ...
          AI-driven platforms, cloud infrastructure, SEO strategy, and
...
>
    <Link
      to="/contact"
      className="group px-10 py-3 rounded-full 
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl shadow-md hover:shadow-xl transition">
              ...
              <p className="text-sm text-gray-600">
                Backend systems, APIs, microservices, and cloud-native
                applications.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl shadow-md hover:shadow-xl transition">
              ...
              <p className="text-sm text-gray-600">
                AI integrations, ML models, workflow automation and
            ...
            <div className="p-8 rounded-2xl shadow-md hover:shadow-xl transition">
              ...
              <p className="text-sm text-gray-600">
                SEO optimization, marketing strategy, brand identity,
